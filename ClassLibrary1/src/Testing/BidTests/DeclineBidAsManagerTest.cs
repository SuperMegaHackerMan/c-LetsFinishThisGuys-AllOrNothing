...
namespace ClassLibrary1.src.Testing
{
    class DeclineBidAsManagerTest
    {
        ...
        static void Main(string[] args)
        {
            ...
            string testName = "DeclineBidAsManagerTest";
            ...
            dans_store.getItem("halav", "dairy", "expired").setProductAsBidOnly();
            Console.WriteLine("\n# Set product as bid only");
            ...
            ms.declineBidAsManager("dan", pavels_bidId);
            Console.WriteLine("\ndan declined pavel's bid");
